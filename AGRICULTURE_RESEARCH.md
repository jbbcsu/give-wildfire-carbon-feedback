...
| Global multiscale drought association | [Santini et al. (2022)](https://doi.org/10.1038/s41598-022-09611-0) compares crop-yield anomalies with SPEI duration, timing, frequency and severity for maize, rice, soybean and wheat. | Supports multiscale crop-calendar SPEI and pre-sowing windows. Its country-level contingency analysis is not a marginal response coefficient. |
| Global water-balance sensitivity | [Tuninetti and Davis (2026)](https://doi.org/10.1038/s41467-026-72715-y) maps historical median-to-tenth-percentile ETa yield sensitivity for 17 crops, separated into rainfed and irrigated systems. | Use the official 5-arc-minute outputs as a spatial process benchmark. Prescribed FAO yield-response factors and a historical-tail contrast prevent direct use as an empirical future yield or SCC coefficient. |
