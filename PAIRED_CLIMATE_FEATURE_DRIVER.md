...
The UKESM SSP3-7.0 end-century pair also passes and reproduces the same-
realization GMST plus exact 5,488-season/16,464-stage reconciliation. Its
exact-key SSP3-7.0-minus-SSP1-2.6 means are +4.293 C, +8.32 mm rain, +1.07 wet
...
The outcome-blind successor was preregistered before fitting in
...
and every response, damage, welfare, and SCC gate remained closed pending the
locked holdout result. That result improves only 34/88 comparisons, with
median/maximum original-scale RMSE ratios of 1.00775/1.13855. Physical-domain
...
GFDL-ESM4 `r1i1p1f1` feature cells for SSP1-2.6, SSP3-7.0, and SSP5-8.5.
Each scenario passes the fixed six-crop by two-calendar audit and contributes
eight centered same-realization GMST templates. Twenty-four templates are
insufficient for the locked 51-template joint-dependence threshold and a
single ESM cannot furnish a whole-ESM holdout, so no FAIR feature, response,
damage, or SCC promotion follows.
