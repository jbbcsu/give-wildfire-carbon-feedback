...
| Predeclared later-century ISIMIP3b support expansion | The live official API validates a full 5-ESM x 3-SSP x 2-variable x 2-period Cartesian product: 30 version-`20210512` datasets and 60 public, unrestricted CC0 files totaling 124,935,312,957 bytes. The fixed blocks are 2041--2050 and 2091--2100; eligible engineering harvest years are 2042--2049 and 2092--2099 so cross-year seasons never cross an unacquired boundary. All six registered GFDL-ESM4 scenario/period `pr`/`tas` pairs and the IPSL-CM6A-LR SSP1-2.6 2041--2050 pair pass full SHA-512, decoded 3,652-day global-grid, same-realization GMST, and bounded-feature gates; IPSL's exact daily timestamp contract is 12:00 rather than GFDL's 00:00. Each variable/block has 946,598,400 finite values and zero missing values; every `pr` block has zero negative values. Each two-latitude-row maize/rainfed smoke produces 5,488 seasonal and 16,464 stage rows with exact additive reconciliation. The joined three-SSP midcentury product has 181,104 rows. Whole-scenario GMST adjustment improves 14/33 feature comparisons versus a cell-mean benchmark (median ratio 1.00036; maximum 1.06410), only 1/11 for held-out SSP5-8.5, and 20,562/181,104 held-out values (11.35%) lie outside the exact two-scenario cell/feature envelope. The matching end-century product improves 13/33 comparisons (median ratio 1.00110; maximum 1.23350), with 27,260/181,104 held-out values (15.05%) outside support. Temperature-only reclassification of paired FAIR paths against the 287.659--291.189 K GFDL envelope puts every 2012--2300 baseline year within the envelope while pairing, identity, and decreasing-pulse gates remain passed. | Fourteen of 60 complete-file gates and seven bounded feature blocks only. Both adverse GFDL scenario holdouts reject promotion; the IPSL expansion does not yet complete a new whole-ESM/scenario product. Support flags describe held-out climate features, not FAIR baseline/pulse features; whole-ESM, response, damage, and SCC gates remain open. The blocks are noncontiguous, and FAIR after 2100 remains outside direct ISIMIP daily-feature support despite the temperature-only envelope. |
