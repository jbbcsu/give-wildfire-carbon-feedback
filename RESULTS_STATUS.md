...
| Matched future climate-feature driver | Frozen official catalogue selects the complete five-ESM/member by four-scenario by four-variable matrix: 80 public/unrestricted CC0 version-`20210512` datasets and 1,756,959,247,729 catalogue bytes. Bounded complete-file `pr`/`tas` coverage now includes historical plus SSP1-2.6/3-7.0/5-8.5 for GFDL-ESM4, IPSL-CM6A-LR, MPI-ESM1-2-HR, and MRI-ESM2-0; UKESM1-0-LL has SSP3-7.0. Every available file passes exact API-byte/SHA-512, decoded-content, historical-boundary, same-realization GMST, and bounded maize/rainfed feature gates. The new MRI SSP1-2.6/5-8.5 block adds four files/4,953,940,488 bytes and exact-reconciliation feature cells. Its historical/four-scenario diagnostic has 113,190 training rows and 44 folds; the simple GMST adjustment improves 24, with median RMSE ratio 0.999710 and maximum 1.099027, so it is not promoted. The exact four-ESM/four-scenario product has 452,760 rows. Whole-ESM folds improve 30/44 (median RMSE ratio 0.997822; maximum 1.044941); whole-scenario folds improve 28/44 (median 0.998195; maximum 1.025096). Historical improves only 3/11 and has median ratio 1.004052. Both engineering gates pass, but the emulator is not promoted. | Seven nonoverlapping years, one crop/regime, and two latitude rows only. The fifth ESM's other scenarios, full temporal/spatial/multi-crop coverage, common-random-number baseline/pulse paths, support flags, zero-pulse/pre-divergence identity, decreasing-pulse convergence, response, damage, and SCC gates remain open. |
