...
| Predeclared later-century ISIMIP3b support expansion | The live official API validates a full 5-ESM x 3-SSP x 2-variable x 2-period Cartesian product: 30 version-`20210512` datasets and 60 public, unrestricted CC0 files totaling 124,935,312,957 bytes. The fixed blocks are 2041--2050 and 2091--2100; eligible engineering harvest years are 2042--2049 and 2092--2099 so cross-year seasons never cross an unacquired boundary. Both registered GFDL-ESM4 SSP1-2.6 `pr`/`tas` pairs and the SSP3-7.0/SSP5-8.5 2041--2050 pairs pass full SHA-512, decoded 3,652-day global-grid, same-realization GMST, and bounded-feature gates. Each variable/block has 946,598,400 finite values and zero missing values; every `pr` block has zero negative values. Each two-latitude-row maize/rainfed smoke produces 5,488 seasonal and 16,464 stage rows with exact additive reconciliation. The joined three-SSP midcentury product has 181,104 rows. Whole-scenario GMST adjustment improves 14/33 feature comparisons versus a cell-mean benchmark (median ratio 1.00036; maximum 1.06410), only 1/11 for held-out SSP5-8.5, and 20,562/181,104 held-out values (11.35%) lie outside the exact two-scenario cell/feature envelope. Temperature-only reclassification of paired FAIR paths moves GFDL's last within-envelope baseline year from 2020 to 2066 while pairing, identity, and decreasing-pulse gates remain passed. | Eight of 60 complete-file gates and four bounded feature blocks only. The adverse scenario holdout rejects promotion. Support flags describe held-out climate features, not FAIR baseline/pulse features; whole-ESM, response, damage, and SCC gates remain open. The blocks are noncontiguous, and FAIR after 2100 remains outside direct ISIMIP training support. |
