...
| Predeclared later-century ISIMIP3b support expansion | The live official API validates a full 5-ESM x 3-SSP x 2-variable x 2-period Cartesian product: 30 version-`20210512` datasets and 60 public, unrestricted CC0 files totaling 124,935,312,957 bytes. The fixed blocks are 2041--2050 and 2091--2100; eligible engineering harvest years are 2042--2049 and 2092--2099 so cross-year seasons never cross an unacquired boundary. Both registered GFDL-ESM4 SSP1-2.6 `pr`/`tas` pairs and the SSP3-7.0 2041--2050 pair pass full SHA-512, decoded 3,652-day global-grid, same-realization GMST, and bounded-feature gates. Each variable/block has 946,598,400 finite values and zero missing values; all three `pr` blocks have zero negative values. Each two-latitude-row maize/rainfed smoke produces 5,488 seasonal and 16,464 stage rows with exact additive reconciliation. Against exact matched SSP1-2.6 midcentury cells, SSP3-7.0 averages +0.574 C, -18.33 mm seasonal rain, -1.11 wet days, and +3.20 maximum dry-spell days. Temperature-only reclassification of validated paired FAIR paths moves GFDL's last within-envelope baseline year from 2020 to 2058 while pairing, identity, and decreasing-pulse gates remain passed. | Six of 60 complete-file gates and three bounded feature blocks only. The SSP differences are descriptive, feature-family support is not extended, and joined whole-ESM/whole-scenario validation remains open. The blocks are noncontiguous, and FAIR after 2100 remains outside direct ISIMIP training support. |
