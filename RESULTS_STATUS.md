...
| U.S. county crop-season drought bridge | Synthetic cross-year USDM interval aggregation passes. The key-safe Quick Stats fallback acquired the exact locked 2019--2021 corn-grain series; strict preparation retained 4,396 real-FIPS county-years (1,257/1,668/1,471) and excluded 254 combined/non-FIPS geography records without inventing identifiers | Historical national/county outcome acquisition only; the yields aggregate all production practices and no crop-area weather exposure, irrigation-screened panel, response estimate, or SCC input is created |
...
| Matched future climate-feature driver | Frozen official catalogue selects the complete five-ESM/member by four-scenario by four-variable matrix: 80 public/unrestricted CC0 version-`20210512` datasets and 1,756,959,247,729 catalogue bytes. The complete pinned MRI-ESM2-0 SSP3-7.0 2015--2020 precipitation file passes SHA-512 and full-array content gates: 2,192 daily global 0.5-degree steps, 568,166,400 finite values, no missing/negative values, and registered flux units. Synthetic same-realization GMST, whole-ESM/scenario, common-residual, separate-support, identity, and three-size convergence gates pass. | One precipitation-block engineering result only; real tas/GMST, historical join, crop features, holdouts, full matrix, fitted response, paired feature path, damage, and SCC input remain absent |
