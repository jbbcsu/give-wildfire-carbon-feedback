...
| Predeclared later-century ISIMIP3b support expansion | The live official API validates a full 5-ESM x 3-SSP x 2-variable x 2-period Cartesian product: 30 version-`20210512` datasets and 60 public, unrestricted CC0 files totaling 124,935,312,957 bytes. The fixed blocks are 2041--2050 and 2091--2100; eligible engineering harvest years are 2042--2049 and 2092--2099 so cross-year seasons never cross an unacquired boundary. The first registered GFDL-ESM4 SSP1-2.6 `pr`/`tas` pair (2041--2050) now passes full SHA-512 and decoded 3,652-day global-grid content validation. `pr` has 946,598,400 finite values, zero missing/negative, and 355,671,623 genuine zeros; `tas` has 946,598,400 finite values, zero missing, and a 191.4101--317.6637 K range. The same-realization `tas` produces ten annual GMST rows. A bounded two-latitude-row maize/rainfed smoke produces 5,488 seasonal and 16,464 stage rows for 2042--2049 with exact additive stage reconciliation. | Two of 60 complete-file gates and one bounded feature block only. Joined holdouts and support effects remain unvalidated. The blocks are noncontiguous, and FAIR after 2100 remains outside direct ISIMIP training support. |
| U.S. national reported-zero support | The exact 1981--2019 all-practice corn source contains 499 reported zero-yield county-years across 150 counties, 18 states, and 217 consecutive spells; the longest spell is 10 years and 118 zero rows have an adjacent positive observation. The fixed geography gate retains 419 rows. Only 45 zero rows have a usable fixed-2017 irrigation share; 7/8/8 meet the 10/20/30% high-rainfed selectors. | Descriptive zero-outcome support only. Nothing is replaced, log-transformed, or modeled; all-practice zeroes are not direct rainfed outcomes. A two-part or other zero-retaining outcome model remains unselected, and no response, damage, or SCC claim is authorized. |
