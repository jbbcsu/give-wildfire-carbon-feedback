...
EXPECTED_SCENARIO_YEARS = {
    ...
    "ssp370": set(range(2015, 2021)) | set(range(2041, 2051)) | set(range(2091, 2101)),
    "ssp585": set(range(2015, 2021)) | set(range(2041, 2051)) | set(range(2091, 2101)),
}
...
def audit(pairs_path: Path, gmst_paths: list[Path]) -> dict[str, object]:
    if len(gmst_paths) != 10 or len(set(gmst_paths)) != len(gmst_paths):
        raise ValueError("expanded support requires the ten unique fixed GMST inputs")
