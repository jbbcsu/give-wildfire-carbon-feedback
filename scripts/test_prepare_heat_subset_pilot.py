...
def fixture():
    config=dict(local_download_authorized=False,local_feature_construction_authorized=False,
        ...
        resource_doi='synthetic-doi',file_id='synthetic-file',file_name='fake_2041_2050.nc',source_path='fake/path/fake_2041_2050.nc',
        expected_gregorian_daily_count=3652,
    ...
    dataset=dict(id='synthetic-dataset',version='v1',public=True,restricted=False,rights={'short':'CC0 1.0'},
        ...
        files=[dict(id='synthetic-file',name='fake_2041_2050.nc',path='fake/path/fake_2041_2050.nc',version='v1',size=10,
...
class TestSubset(unittest.TestCase):
    def test_single_exact_path_and_no_averaging(self):
        ...
        self.assertEqual(p['paths'],['fake/path/fake_2041_2050.nc'])
