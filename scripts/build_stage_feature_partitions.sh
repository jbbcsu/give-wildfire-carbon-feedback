...
# Resumable latitude partitions for crop-stage features.
# Usage mirrors build_feature_partitions.sh with an optional stage fraction list.
if [[ $# -lt 8 || $# -gt 10 ]]; then
  echo "Usage: $0 PR.nc TAS.nc CALENDAR.nc CROP IRR YEAR0 YEAR1 OUTDIR [CHUNK] [FRACTIONS]" >&2
  exit 2
fi
pr=$1; tas=$2; calendar=$3; crop=$4; irrigation=$5; year0=$6; year1=$7; outdir=$8; chunk=${9:-10}; fractions=${10:-0,0.3,0.7,1}
