...
class TestDroughtFairExportContract(unittest.TestCase):
    def test_export_parses_and_preserves_closed_gates(self):
        source = (ROOT/"scripts/export_five_esm_drought_fair_sensitivity.py").read_text()
        ast.parse(source)
