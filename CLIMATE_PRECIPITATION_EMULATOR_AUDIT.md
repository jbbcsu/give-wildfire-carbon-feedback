...
| RIME-X, Quilcaille et al. (2026), https://doi.org/10.5194/gmd-19-6797-2026 | Links simple-climate-model warming distributions to country-level CMIP6 regional climate and impact indicators, with held-out-scenario validation. | SCC-compatible uncertainty and validation precedent. | Current precipitation demonstration is annual, country-level, and smoothed; it cannot recover crop-season sequences. |
