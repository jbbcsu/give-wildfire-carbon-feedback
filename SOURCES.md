...
| Irrigated/rainfed exposure weights | [Kebede et al. (2025), MIRCA-OS](https://doi.org/10.1038/s41597-024-04313-w), [v2 data release](https://www.hydroshare.org/resource/e4582ca0042148338bb5e0148b749ed6/), and [official generation-code snapshot](https://github.com/EndiKebede/MIRCA-OS_Code/tree/c72d9dab7722a1c04ca1c7e90e21a16bc4a74089) | Global crop-specific harvested-area shares at 0.5°; exact annual maize/soybean mappings pass. Rice season files fail metadata and annual-reconciliation gates, while spring/winter wheat lacks a documented mapping. |
...
| US daily historical weather validation | [Official NOAA nClimGrid-Daily documentation](https://www.ncei.noaa.gov/products/land-based-station/nclimgrid-daily), [official gridMET documentation](https://www.climatologylab.org/gridmet.html), and [Abatzoglou (2013)](https://doi.org/10.1002/joc.3413) | nClimGrid supplies the county-polygon primary daily exposure; gridMET is a robustness route and the 2017 CDL supplies a separate crop-pixel weighting sensitivity. The gridMET precipitation-inhomogeneity warning rules out using it alone to infer intensity/frequency trends. |
