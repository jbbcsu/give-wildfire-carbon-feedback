...
The synthesis reads only three already-audited aggregate artifacts. It reads
no county yield rows, coefficients, predictions, or raw weather. An independent
implementation rehashes all sources and repeats 100 aggregate identity,
...
- Ignored result: `data/interim/us_nass_evidence_synthesis_20260919.json`
- The builder and audit each used less than 1 MiB sampled RSS.
